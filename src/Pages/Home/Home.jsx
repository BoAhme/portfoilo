...
const Home = () => {
  const texts = [
    "Building scalable backend systems with .NET Core, ASP.NET Core, and Entity Framework Core.",
    "Designing clean architecture, RESTful APIs, and production-ready solutions.",
  ];
    ...
    >
      <div className="left-side flex-1 flex flex-col justify-center lg:py-0 py-10">
        ...
        >
          ...
          >
            Building full-stack applications with Angular and .NET.
          </motion.span>
        </motion.div>
        <motion.div
        ...
        >
          <a
            href="https://github.com/AhmedAymanSC"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/ibn__ayman/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-white active:text-white transition-all duration-300 ease-in-out cursor-pointer"
          >
          ...
          <a
            href="https://www.linkedin.com/in/ahmed-ayman-a666893a0/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-white active:text-white transition-all duration-300 ease-in-out cursor-pointer"
          >
